const { S, StringExtra } = require('./index').default;
...
const examples = {
  ...
  "Custom Styles": [
    S('Completely custom styling using your own array of styles that alternate between letters.').style(['blue.underline', 'pink.underline']).config('styleSpaces', true),
  ],
};
